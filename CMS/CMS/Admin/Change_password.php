...
$sql ="SELECT Password  FROM login WHERE user_id =:username and Password =:password";
...
if($query -> rowCount() > 0)
{
$con="update login set Password=:newpassword where user_id =:username";
$chngpwd1 = $db_conn->prepare($con);
